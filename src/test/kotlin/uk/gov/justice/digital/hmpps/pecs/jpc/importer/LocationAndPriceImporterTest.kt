...
internal class LocationAndPriceImporterTest(
  ...
  private val locationRepositorySpy: LocationRepository =
    mock { on { deleteAll() } doAnswer { locationRepository.deleteAll() } }
  ...
  private val importer: LocationAndPriceImporter =
    LocationAndPriceImporter(priceRepositorySpy, locationRepositorySpy, importServiceSpy)
