...
"""
    ...
    fun `Correct JSON is created from Move and successfully parsed back to Move again`(){
        ...
        val expectedJson = """{"cancellation_reason" : "", "cancellation_reason_comment" : null, "from_location" : "WYI", "date" : "2021-02-28", "id" : "M1", "profile_id" : "PR1", "reference" : "UKW4591N", "from_location_type" : "prison", "to_location_type" : "court", "status" : "completed", "supplier" : "SERCO", "to_location" : "GNI", "updated_at" : "2020-06-16T10:20:30"}"""
