...
internal class MoneyTest {
  ...
  @Test
  internal fun `pence to BigDecimal in pounds`() {
    assertThat(Money(1000).pounds()).isEqualTo(BigDecimal("10.00"))
    assertThat(Money(1001).pounds()).isEqualTo(BigDecimal("10.01"))
  }
}
