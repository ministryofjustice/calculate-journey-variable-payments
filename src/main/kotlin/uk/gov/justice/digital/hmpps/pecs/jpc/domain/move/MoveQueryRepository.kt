...
class MoveQueryRepository(@Autowired val jdbcTemplate: JdbcTemplate) {
  ...
  val moveJourneySelectSQL =
    """
        ...
        j.vehicle_registration as move_vehicle_reg, j.vehicle_registration as journey_vehicle_reg, j.state as journey_state,  
  ...
  val moveJourneyRowMapper = RowMapper { resultSet: ResultSet, _: Int ->
    with(resultSet) {
      val move = Move(
        ...
        vehicleRegistration = getString("move_vehicle_reg"),
